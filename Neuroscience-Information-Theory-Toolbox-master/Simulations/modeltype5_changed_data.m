...
% Center Out Model
parametersCO = struct;
parametersCO.maxFR = 200;
parametersCO.meanLead = -200;
...
parametersPC.stepDur = 20;
parametersPC.nSteps = 30000;
parametersPC.nStepsDim = 30;
parametersPC.respRange = [0,1];

% Sensory Habituation parameters
parametersSH = struct;
parametersSH.nStimSets = 50;
parametersSH.interstimT = 600;
parametersSH.intrastimT = 600;
parametersSH.pulseSize = 600;
