...
disp('Running NeuroDemo2')
disp('This code explores how individual neurons encode information, focusing on the impact of stimuli and inhibition. 
It involves analyzing neural responses to various inputs and assessing how inhibitory processes affect neuronal activity.')
...
for iSubType = 1:nSTs
    for iModel = 1:nModelsPerSubtype
        ...
        [mV,spkTimes,memNoise,current,stim,modelParams] = modeltype2_changed_data(pulseSize, weights(iSubType,:), 'noiseScale', noiseScale(iSubType)*ones([1,3]));
