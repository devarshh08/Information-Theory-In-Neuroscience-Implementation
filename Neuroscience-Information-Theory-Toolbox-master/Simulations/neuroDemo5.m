...
disp('Running NeuroDemo5')
disp('This code is used for simulating and analyzing the encoding of neural stimuli by reproducing the canonical neuroscience experiment.')
