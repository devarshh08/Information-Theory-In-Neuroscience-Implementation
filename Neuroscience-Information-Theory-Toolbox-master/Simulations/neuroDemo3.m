...
disp('Running NeuroDemo3')
disp('This code is used for simulating and analyzing the eeg wave signals which are reproduced by Izhikevich network simulations.')
