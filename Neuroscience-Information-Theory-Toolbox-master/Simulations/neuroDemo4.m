...
disp('Running NeuroDemo4')
disp('This code is used for simulating and analyzing the encoding of neural stimuli by reproducing the small network simulations')
...
for iSubType = 1:nSTs
    for iModel = 1:nModelsPerSubtype
        ...
        [mV,spkTimes,memNoise,current,stim,modelParams] = modeltype4_changed_data(pulseSize, weights(iSubType,:), neuronTypes{iSubType}, backgroundCurrent(iSubType), ...
